...
public class FamilyTree {
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Invalid colon index");      // with a useful message
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException("Error parent not found");
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("Person 1 not found"); //Throw a TreeException with a useful message
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("Person 2 not found"); //Throw TreeException with a useful message
